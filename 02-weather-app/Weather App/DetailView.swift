...
//  WeatherAppLC
//
//  Created by John Kulimushi on 25/09/2019.
    ...
    var body: some View {
        GeometryReader { gr in
            ZStack {
                ...
                }.frame(minWidth: 0, maxWidth: .infinity, minHeight: gr.size.height, alignment: .bottom).background(Color("Primary")).clipShape(CustomShape(), style: FillStyle.init(eoFill: true, antialiased: true))
...
struct DetailView_Previews: PreviewProvider {
    static var previews: some View {
        DetailView(weather: .constant(Weather(id: 1, day: "Monday", weatherIcon:  "sun.max", currentTemp:  "40", minTemp: "25", maxTemp: "69", color: "mainCard")), showDetails: .constant(false))
    }
}
